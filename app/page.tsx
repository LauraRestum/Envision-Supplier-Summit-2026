    ...
    <main>
      ...
      <section className="section" id="agenda">
        ...
        {mainSchedule.map((day, dayIdx) => (
          <div key={day.date} className="day-block rv" style={{ transitionDelay: `${0.1 + dayIdx * 0.12}s` }}>
      ...
      <section className="beyond-section">
        ...
        <div className="agenda-grid">
          {beyondTheSummit.events.map((event, i) => (
            <div key={event.title} className="beyond-card rv" style={{ transitionDelay: `${0.1 + i * 0.12}s` }}>
        ...
        <p className="beyond-registration rv">
